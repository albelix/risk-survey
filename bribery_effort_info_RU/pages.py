...
class Results2(Page):
        def vars_for_template(self):
            all_contributions = [(g.contribution_A+g.contribution_B)/2 for g in self.subsession.get_groups()]
            average_contribution = sum(all_contributions) / len(all_contributions)
